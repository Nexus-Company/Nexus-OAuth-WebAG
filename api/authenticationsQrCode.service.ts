...
export class AuthenticationsQrCodeService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAuthenticationsQrCodeGenerateGet(clientKey?: string, userAgent?: string, theme?: Theme, transparent?: boolean, pixeisPerModule?: number, extension?: ImageExtension, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public apiAuthenticationsQrCodeGenerateGet(clientKey?: string, userAgent?: string, theme?: Theme, transparent?: boolean, pixeisPerModule?: number, extension?: ImageExtension, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public apiAuthenticationsQrCodeGenerateGet(clientKey?: string, userAgent?: string, theme?: Theme, transparent?: boolean, pixeisPerModule?: number, extension?: ImageExtension, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public apiAuthenticationsQrCodeGenerateGet(clientKey?: string, userAgent?: string, theme?: Theme, transparent?: boolean, pixeisPerModule?: number, extension?: ImageExtension, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/api/Authentications/QrCode/Generate`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
