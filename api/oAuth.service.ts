...
export class OAuthService {
     ...
     */
    public apiOAuthAccessTokenGet(grantType: GrantType, clientId: string, clientSecret: string, userAgent?: string, authorization?: string, code?: string, redirectUri?: string, scope?: string, refreshToken?: string, observe?: 'body', reportProgress?: boolean): Observable<AuthenticationResult>;
    public apiOAuthAccessTokenGet(grantType: GrantType, clientId: string, clientSecret: string, userAgent?: string, authorization?: string, code?: string, redirectUri?: string, scope?: string, refreshToken?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AuthenticationResult>>;
    public apiOAuthAccessTokenGet(grantType: GrantType, clientId: string, clientSecret: string, userAgent?: string, authorization?: string, code?: string, redirectUri?: string, scope?: string, refreshToken?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AuthenticationResult>>;
    public apiOAuthAccessTokenGet(grantType: GrantType, clientId: string, clientSecret: string, userAgent?: string, authorization?: string, code?: string, redirectUri?: string, scope?: string, refreshToken?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiOAuthOIDCAccessTokenPostForm(authorization: string, scopes: string, grantType?: GrantType, code?: string, age?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiOAuthOIDCAccessTokenPostForm(authorization: string, scopes: string, grantType?: GrantType, code?: string, age?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiOAuthOIDCAccessTokenPostForm(authorization: string, scopes: string, grantType?: GrantType, code?: string, age?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiOAuthOIDCAccessTokenPostForm(authorization: string, scopes: string, grantType?: GrantType, code?: string, age?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling apiOAuthOIDCAccessTokenPost.');
        }
