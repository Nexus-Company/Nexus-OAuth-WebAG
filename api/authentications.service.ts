...
export class AuthenticationsService {
     ...
     */
    public apiAuthenticationsFirstStepGet(userAgent?: string, clientKey?: string, user?: string, hCaptchaToken?: string, observe?: 'body', reportProgress?: boolean): Observable<FirstStepResult>;
    public apiAuthenticationsFirstStepGet(userAgent?: string, clientKey?: string, user?: string, hCaptchaToken?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<FirstStepResult>>;
    public apiAuthenticationsFirstStepGet(userAgent?: string, clientKey?: string, user?: string, hCaptchaToken?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<FirstStepResult>>;
    public apiAuthenticationsFirstStepGet(userAgent?: string, clientKey?: string, user?: string, hCaptchaToken?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (hCaptchaToken !== undefined && hCaptchaToken !== null) {
            queryParameters = queryParameters.set('hCaptchaToken', <any>hCaptchaToken);
        }
        ...
        return this.httpClient.request<FirstStepResult>('get',`${this.basePath}/api/Authentications/FirstStep`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAuthenticationsLogoutPost(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiAuthenticationsLogoutPost(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiAuthenticationsLogoutPost(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiAuthenticationsLogoutPost(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/Authentications/Logout`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAuthenticationsRefreshPost(refreshToken: string, authorization?: string, observe?: 'body', reportProgress?: boolean): Observable<AuthenticationResult>;
    public apiAuthenticationsRefreshPost(refreshToken: string, authorization?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AuthenticationResult>>;
    public apiAuthenticationsRefreshPost(refreshToken: string, authorization?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AuthenticationResult>>;
    public apiAuthenticationsRefreshPost(refreshToken: string, authorization?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (refreshToken === null || refreshToken === undefined) {
            throw new Error('Required parameter refreshToken was null or undefined when calling apiAuthenticationsRefreshPost.');
        }
        ...
        return this.httpClient.request<AuthenticationResult>('post',`${this.basePath}/api/Authentications/Refresh`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAuthenticationsSecondStepGet(pwd?: string, token?: string, fsId?: number, observe?: 'body', reportProgress?: boolean): Observable<AuthenticationResult>;
    public apiAuthenticationsSecondStepGet(pwd?: string, token?: string, fsId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AuthenticationResult>>;
    public apiAuthenticationsSecondStepGet(pwd?: string, token?: string, fsId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AuthenticationResult>>;
    public apiAuthenticationsSecondStepGet(pwd?: string, token?: string, fsId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (fsId !== undefined && fsId !== null) {
            queryParameters = queryParameters.set('fs_id', <any>fsId);
        }
        ...
        return this.httpClient.request<AuthenticationResult>('get',`${this.basePath}/api/Authentications/SecondStep`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
